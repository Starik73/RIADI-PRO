! function(e) {
    ...
    s = 0, (r = function(e, t) {
        ...
        if (!0 === n.options.centerMode ? i = !0 === n.options.infinite ? (t = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (t = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (t = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, i = Math.ceil(t + n.options.slidesToShow), !0 === n.options.fade && (0 < t && t--, i <= n.slideCount && i++)), e = n.$slider.find(".slick-slide").slice(t, i), "anticipated" === n.options.lazyLoad)
            for (var s = t - 1, r = i, a = n.$slider.find(".slick-slide"), l = 0; l < n.options.slidesToScroll; l++) s < 0 && (s = n.slideCount - 1), e = (e = e.add(a.eq(s))).add(a.eq(r)), s--, r++;
        ...
        a.length ? (t = a.first(), i = t.attr("data-lazy"), o = t.attr("data-srcset"), s = t.attr("data-sizes") || r.$slider.attr("data-sizes"), (n = document.createElement("img")).onload = function() {
        ...
        var e, t, i, o, s, n = this,
            r = !1;
        if ("object" === d.type(arguments[0]) ? (i = arguments[0], r = arguments[1], s = "multiple") : "string" === d.type(arguments[0]) && (o = arguments[1], r = arguments[2], "responsive" === (i = arguments[0]) && "array" === d.type(arguments[1]) ? s = "responsive" : void 0 !== arguments[1] && (s = "single")), "single" === s) n.options[i] = o;
        ...
        if (i = n.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), n.$slides.eq(e).addClass("slick-current"), !0 === n.options.centerMode) {
            ...
            t = Math.floor(n.options.slidesToShow / 2), !0 === n.options.infinite && (t <= e && e <= n.slideCount - 1 - t ? n.$slides.slice(e - t + r, e + t + 1).addClass("slick-active").attr("aria-hidden", "false") : (o = n.options.slidesToShow + e, i.slice(o - t + 1 + r, o + t + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === e ? i.eq(i.length - 1 - n.options.slidesToShow).addClass("slick-center") : e === n.slideCount - 1 && i.eq(n.options.slidesToShow).addClass("slick-center")), n.$slides.eq(e).addClass("slick-center")
        } else 0 <= e && e <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(e, e + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : i.length <= n.options.slidesToShow ? i.addClass("slick-active").attr("aria-hidden", "false") : (s = n.slideCount % n.options.slidesToShow, o = !0 === n.options.infinite ? n.options.slidesToShow + e : e, n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - e < n.options.slidesToShow ? i.slice(o - (n.options.slidesToShow - s), o + s).addClass("slick-active").attr("aria-hidden", "false") : i.slice(o, o + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false"));
        ...
        return n = void 0 !== e.originalEvent ? e.originalEvent.touches : null, !(!a.dragging || a.scrolling || n && 1 !== n.length) && (t = a.getLeft(a.currentSlide), a.touchObject.curX = void 0 !== n ? n[0].pageX : e.clientX, a.touchObject.curY = void 0 !== n ? n[0].pageY : e.clientY, a.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(a.touchObject.curX - a.touchObject.startX, 2))), r = Math.round(Math.sqrt(Math.pow(a.touchObject.curY - a.touchObject.startY, 2))), !a.options.verticalSwiping && !a.swiping && 4 < r ? !(a.scrolling = !0) : (!0 === a.options.verticalSwiping && (a.touchObject.swipeLength = r), i = a.swipeDirection(), void 0 !== e.originalEvent && 4 < a.touchObject.swipeLength && (a.swiping = !0, e.preventDefault()), s = (!1 === a.options.rtl ? 1 : -1) * (a.touchObject.curX > a.touchObject.startX ? 1 : -1), !0 === a.options.verticalSwiping && (s = a.touchObject.curY > a.touchObject.startY ? 1 : -1), o = a.touchObject.swipeLength, (a.touchObject.edgeHit = !1) === a.options.infinite && (0 === a.currentSlide && "right" === i || a.currentSlide >= a.getDotCount() && "left" === i) && (o = a.touchObject.swipeLength * a.options.edgeFriction, a.touchObject.edgeHit = !0), !1 === a.options.vertical ? a.swipeLeft = t + o * s : a.swipeLeft = t + o * (a.$list.height() / a.listWidth) * s, !0 === a.options.verticalSwiping && (a.swipeLeft = t + o * s), !0 !== a.options.fade && !1 !== a.options.touchMove && (!0 === a.animating ? (a.swipeLeft = null, !1) : void a.setCSS(a.swipeLeft))))
        ...
        var e, t, i = this,
            ...
            n = i.length;
        for (e = 0; e < n; e++)
            if ("object" == typeof o || void 0 === o ? i[e].slick = new r(i[e], o) : t = i[e].slick[o].apply(i[e].slick, s), void 0 !== t) return t;
        return i
    }
}), $(".slider").slick({
        slidesToShow: 1,
    ...
    function(e) {
        ...
        function t(e) {
            var t = e || window.event,
                ...
                r = 0;
            r = 0;
            (e = a.event.fix(t)).type = "mousewheel", t.wheelDelta && (o = t.wheelDelta), t.detail && (o = -1 * t.detail), t.deltaY && (o = n = -1 * t.deltaY), t.deltaX && (o = -1 * (s = t.deltaX)), void 0 !== t.wheelDeltaY && (n = t.wheelDeltaY), void 0 !== t.wheelDeltaX && (s = -1 * t.wheelDeltaX), r = Math.abs(o), (!l || r < l) && (l = r), r = Math.max(Math.abs(n), Math.abs(s)), (!d || r < d) && (d = r), t = 0 < o ? "floor" : "ceil", o = Math[t](o / l), s = Math[t](s / d), n = Math[t](n / d);
            try {
                e.originalEvent.hasOwnProperty("wheelDelta")
            } catch (e) {
                n = o
            }
            return i.unshift(e, o, s, n), (a.event.dispatch || a.event.handle).apply(this, i)
        }
        var l, d, e = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
            i = "onwheel" in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"];
        if (a.event.fixHooks)
            for (var o = e.length; o;) a.event.fixHooks[e[--o]] = a.event.mouseHooks;
    ...
    function(s, i, $, c) {
        ...
        function A(e, t) {
            ...
            return t && O(e) && (i *= H.getViewport()[t] / 100), Math.ceil(i)
        }
        ...
        $.extend(H, {
            ...
            helpers: {},
            open: function(l, d) {
                if (l && ($.isPlainObject(d) || (d = {}), !1 !== H.close(!0))) return $.isArray(l) || (l = p(l) ? $(l).get() : [l]), $.each(l, function(e, t) {
                    var i, o, s, n, r, a = {};
                    "object" === $.type(t) && (t.nodeType && (t = $(t)), p(t) ? (a = {
                        href: t.data("fancybox-href") || t.attr("href"),
                        title: $("<div/>").text(t.data("fancybox-title") || t.attr("title") || "").html(),
                        isDom: !0,
                        element: t
                    }, $.metadata && $.extend(!0, a, t.metadata())) : a = t), i = d.href || a.href || (u(t) ? t : null), o = d.title !== c ? d.title : a.title || "", !(n = (s = d.content || a.content) ? "html" : d.type || a.type) && a.isDom && (n = (n = t.data("fancybox-type")) || ((n = t.prop("class").match(/fancybox\.(\w+)/)) ? n[1] : null)), u(i) && (n || (H.isImage(i) ? n = "image" : H.isSWF(i) ? n = "swf" : "#" === i.charAt(0) ? n = "inline" : u(t) && (n = "html", s = t)), "ajax" === n && (i = (r = i.split(/\s+/, 2)).shift(), r = r.shift())), s || ("inline" === n ? i ? s = $(u(i) ? i.replace(/.*(?=#[^\s]+$)/, "") : i) : a.isDom && (s = t) : "html" === n ? s = i : n || i || !a.isDom || (n = "inline", s = t)), $.extend(a, {
                        href: i,
                        type: n,
                        content: s,
                        title: o,
                ...
                }), H.opts = $.extend(!0, {}, H.defaults, d), d.keys !== c && (H.opts.keys = !!d.keys && $.extend({}, H.defaults.keys, d.keys)), H.group = l, H._start(H.opts.index)
            },
            cancel: function() {
                var e = H.coming;
                e && !1 === H.trigger("onCancel") || (H.hideLoading(), e && (H.ajaxLoad && H.ajaxLoad.abort(), H.ajaxLoad = null, H.imgPreload && (H.imgPreload.onload = H.imgPreload.onerror = null), e.wrap && e.wrap.stop(!0, !0).trigger("onReset").remove(), H.coming = null, H.current || H._afterZoomOut(e)))
            },
            close: function(e) {
                H.cancel(), !1 !== H.trigger("beforeClose") && (H.unbindEvents(), H.isActive && (H.isOpen && !0 !== e ? (H.isOpen = H.isOpened = !1, H.isClosing = !0, $(".fancybox-item, .fancybox-nav").remove(), H.wrap.stop(!0, !0).removeClass("fancybox-opened"), H.transitions[H.current.closeMethod]()) : ($(".fancybox-wrap").stop(!0).trigger("onReset").remove(), H._afterZoomOut())))
            },
            play: function(e) {
                function t() {
                ...
                function i() {
                    t(), H.current && H.player.isActive && (H.player.timer = setTimeout(H.next, H.current.playSpeed))
                }

                function o() {
                    t(), d.unbind(".player"), H.player.isActive = !1, H.trigger("onPlayEnd")
                }!0 === e || !H.player.isActive && !1 !== e ? H.current && (H.current.loop || H.current.index < H.group.length - 1) && (H.player.isActive = !0, d.bind({
                    "onCancel.player beforeClose.player": o,
                    "onUpdate.player": i,
                    "beforeLoad.player": t
                }), i(), H.trigger("onPlayStart")) : o()
            },
            next: function(e) {
                var t = H.current;
                t && (u(e) || (e = t.direction.next), H.jumpto(t.index + 1, e, "next"))
            },
            prev: function(e) {
                var t = H.current;
                t && (u(e) || (e = t.direction.prev), H.jumpto(t.index - 1, e, "prev"))
            },
            jumpto: function(e, t, i) {
                var o = H.current;
                o && (e = A(e), H.direction = t || o.direction[e >= o.index ? "next" : "prev"], H.router = i || "jumpto", o.loop && (e < 0 && (e = o.group.length + e % o.group.length), e %= o.group.length), o.group[e] !== c && (H.cancel(), H._start(e)))
            },
            reposition: function(e, t) {
                var i, o = H.current,
                    s = o ? o.wrap : null;
                s && (i = H._getPosition(t), e && "scroll" === e.type ? (delete i.position, s.stop(!0, !0).animate(i, 200)) : (s.css(i), o.pos = $.extend({}, o.dim, i)))
            },
            update: function(t) {
                var i = t && t.originalEvent && t.originalEvent.type,
                    o = !i || "orientationchange" === i;
                o && (clearTimeout(a), a = null), H.isOpen && !a && (a = setTimeout(function() {
                    var e = H.current;
                    e && !H.isClosing && (H.wrap.removeClass("fancybox-tmp"), (o || "load" === i || "resize" === i && e.autoResize) && H._setDimension(), "scroll" === i && e.canShrink || H.reposition(t), H.trigger("onUpdate"), a = null)
                }, o && !l ? 0 : 300))
            },
            toggle: function(e) {
                H.isOpen && (H.current.fitToView = "boolean" === $.type(e) ? e : !H.current.fitToView, l && (H.wrap.removeAttr("style").addClass("fancybox-tmp"), H.trigger("onUpdate")), H.update())
            },
            ...
            showLoading: function() {
                var e, t;
                H.hideLoading(), e = $(H.opts.tpl.loading).click(H.cancel).appendTo("body"), d.bind("keydown.loading", function(e) {
                    27 === (e.which || e.keyCode) && (e.preventDefault(), H.cancel())
                }), H.defaults.fixed || (t = H.getViewport(), e.css({
                    position: "absolute",
                    top: .5 * t.h + t.y,
                    left: .5 * t.w + t.x
                })), H.trigger("onLoading")
            ...
            getViewport: function() {
                ...
                return e && e.length ? (t.w = e[0].clientWidth, t.h = e[0].clientHeight) : (t.w = l && s.innerWidth ? s.innerWidth : o.width(), t.h = l && s.innerHeight ? s.innerHeight : o.height()), t
            },
            unbindEvents: function() {
                H.wrap && p(H.wrap) && H.wrap.unbind(".fb"), d.unbind(".fb"), o.unbind(".fb")
            },
            bindEvents: function() {
                var t, r = H.current;
                r && (o.bind("orientationchange.fb" + (l ? "" : " resize.fb") + (r.autoCenter && !r.locked ? " scroll.fb" : ""), H.update), (t = r.keys) && d.bind("keydown.fb", function(i) {
                    var o = i.which || i.keyCode,
                        e = i.target || i.srcElement;
                    if (27 === o && H.coming) return !1;
                    i.ctrlKey || i.altKey || i.shiftKey || i.metaKey || e && (e.type || $(e).is("[contenteditable]")) || $.each(t, function(e, t) {
                        return 1 < r.group.length && t[o] !== c ? (H[e](t[o]), i.preventDefault(), !1) : -1 < $.inArray(o, t) ? (H[e](), i.preventDefault(), !1) : void 0
                    })
                }), $.fn.mousewheel && r.mouseWheel && H.wrap.bind("mousewheel.fb", function(e, t, i, o) {
                    for (var s = $(e.target || null), n = !1; s.length && !(n || s.is(".fancybox-skin") || s.is(".fancybox-wrap"));) n = (n = s[0]) && !(n.style.overflow && "hidden" === n.style.overflow) && (n.clientWidth && n.scrollWidth > n.clientWidth || n.clientHeight && n.scrollHeight > n.clientHeight), s = $(s).parent();
                    0 !== t && !n && 1 < H.group.length && !r.canShrink && (0 < o || 0 < i ? H.prev(0 < o ? "down" : "left") : (o < 0 || i < 0) && H.next(o < 0 ? "up" : "right"), e.preventDefault())
                }))
            },
            trigger: function(i, e) {
                var t, o = e || H.coming || H.current;
                if (o) {
                    if ($.isFunction(o[i]) && (t = o[i].apply(o, Array.prototype.slice.call(arguments, 1))), !1 === t) return !1;
                    o.helpers && $.each(o.helpers, function(e, t) {
                        t && H.helpers[e] && $.isFunction(H.helpers[e][i]) && H.helpers[e][i]($.extend(!0, {}, H.helpers[e].defaults, t), o)
                    })
                }
                d.trigger(i)
            },
            ...
            _start: function(e) {
                var t, i, o = {};
                if (e = A(e), !(t = H.group[e] || null)) return !1;
                if (t = (o = $.extend(!0, {}, H.opts, t)).margin, i = o.padding, "number" === $.type(t) && (o.margin = [t, t, t, t]), "number" === $.type(i) && (o.padding = [i, i, i, i]), o.modal && $.extend(!0, o, {
                        closeBtn: !1,
                        closeClick: !1,
                        nextClick: !1,
                        arrows: !1,
                    ...
                    }), o.autoSize && (o.autoWidth = o.autoHeight = !0), "auto" === o.width && (o.autoWidth = !0), "auto" === o.height && (o.autoHeight = !0), o.group = H.group, o.index = e, H.coming = o, !1 === H.trigger("beforeLoad")) H.coming = null;
                else {
                    if (i = o.type, t = o.href, !i) return H.coming = null, !(!H.current || !H.router || "jumpto" === H.router) && (H.current.index = e, H[H.router](H.direction));
                    if (H.isActive = !0, "image" !== i && "swf" !== i || (o.autoHeight = o.autoWidth = !1, o.scrolling = "visible"), "image" === i && (o.aspectRatio = !0), "iframe" === i && l && (o.scrolling = "scroll"), o.wrap = $(o.tpl.wrap).addClass("fancybox-" + (l ? "mobile" : "desktop") + " fancybox-type-" + i + " fancybox-tmp " + o.wrapCSS).appendTo(o.parent || "body"), $.extend(o, {
                        ...
                        if (!o.content || !o.content.length) return H._error("content")
            ...
            _loadAjax: function() {
                var i = H.coming;
                H.showLoading(), H.ajaxLoad = $.ajax($.extend({}, i.ajax, {
                    url: i.href,
                    error: function(e, t) {
                        H.coming && "abort" !== t ? H._error("ajax", e) : H.hideLoading()
                    },
                    success: function(e, t) {
                        "success" === t && (i.content = e, H._afterLoad())
                    }
                }))
            },
            _loadIframe: function() {
                var e = H.coming,
                    t = $(e.tpl.iframe.replace(/\{rnd\}/g, (new Date).getTime())).attr("scrolling", l ? "auto" : e.iframe.scrolling).attr("src", e.href);
                $(e.wrap).bind("onReset", function() {
                    try {
                        $(this).find("iframe").hide().attr("src", "//about:blank").end().empty()
                    } catch (e) {}
                }), e.iframe.preload && (H.showLoading(), t.one("load", function() {
                    $(this).data("ready", 1), l || $(this).bind("load.fb", H.update), $(this).parents(".fancybox-wrap").width("100%").removeClass("fancybox-tmp").show(), H._afterLoad()
                })), e.content = t.appendTo(e.inner), e.iframe.preload || H._afterLoad()
            },
            ...
            _afterLoad: function() {
                var i, e, t, o, s, n = H.coming,
                    r = H.current;
                if (H.hideLoading(), n && !1 !== H.isActive)
                    if (!1 === H.trigger("afterLoad", n, r)) n.wrap.stop(!0).trigger("onReset").remove(), H.coming = null;
                    else {
                        switch (r && (H.trigger("beforeChange", r), r.wrap.stop(!0).removeClass("fancybox-opened").find(".fancybox-item, .fancybox-nav").remove()), H.unbindEvents(), i = n.content, e = n.type, t = n.scrolling, $.extend(H, {
                            wrap: n.wrap,
                            skin: n.skin,
                            outer: n.outer,
                            inner: n.inner,
                            ...
                            case "ajax":
                            case "html":
                                n.selector ? i = $("<div>").html(i).find(n.selector) : p(i) && (i.data("fancybox-placeholder") || i.data("fancybox-placeholder", $('<div class="fancybox-placeholder"></div>').insertAfter(i).hide()), i = i.show().detach(), n.wrap.bind("onReset", function() {
                                    $(this).find(i).length && i.hide().replaceAll(i.data("fancybox-placeholder")).data("fancybox-placeholder", !1)
                                }));
                                break;
                            case "image":
                                i = n.tpl.image.replace(/\{href\}/g, o);
                                break;
                            case "swf":
                                i = '<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="' + o + '"></param>', s = "", $.each(n.swf, function(e, t) {
                                    i += '<param name="' + e + '" value="' + t + '"></param>', s += " " + e + '="' + t + '"'
                                }), i += '<embed src="' + o + '" type="application/x-shockwave-flash" width="100%" height="100%"' + s + "></embed></object>"
                        }
                        p(i) && i.parent().is(n.inner) || n.inner.append(i), H.trigger("beforeShow"), n.inner.css("overflow", "yes" === t ? "scroll" : "no" === t ? "hidden" : t), H._setDimension(), H.reposition(), H.isOpen = !1, H.coming = null, H.bindEvents(), H.isOpened ? r.prevMethod && H.transitions[r.prevMethod]() : $(".fancybox-wrap").not(n.wrap).stop(!0).trigger("onReset").remove(), H.transitions[H.isOpened ? n.nextMethod : n.openMethod](), H._preloadImages()
                    }
            },
            _setDimension: function() {
                var e, t = H.getViewport(),
                    i = 0,
                    o = H.wrap,
                    s = H.skin,
                    n = H.inner,
                    r = H.current;
                e = r.width;
                var a, l, d, c, p, u, h, f, g, v = r.height,
                    y = r.minWidth,
                    w = r.minHeight,
                    m = r.maxWidth,
                    b = r.maxHeight,
                    k = r.scrolling,
                    x = r.scrollOutside ? r.scrollbarWidth : 0,
                    S = r.margin,
                    T = A(S[1] + S[3]),
                    C = A(S[0] + S[2]);
                if (o.add(s).add(n).width("auto").height("auto").removeClass("fancybox-tmp"), l = T + (S = A(s.outerWidth(!0) - s.width())), d = C + (a = A(s.outerHeight(!0) - s.height())), c = O(e) ? (t.w - l) * A(e) / 100 : e, p = O(v) ? (t.h - d) * A(v) / 100 : v, "iframe" === r.type) {
                    if (g = r.content, r.autoHeight && g && 1 === g.data("ready")) try {
                        g[0].contentWindow.document.location && (n.width(c).height(9999), u = g.contents().find("body"), x && u.css("overflow-x", "hidden"), p = u.outerHeight(!0))
                    } catch (e) {}
                } else(r.autoWidth || r.autoHeight) && (n.addClass("fancybox-tmp"), r.autoWidth || n.width(c), r.autoHeight || n.height(p), r.autoWidth && (c = n.width()), r.autoHeight && (p = n.height()), n.removeClass("fancybox-tmp"));
                if (e = A(c), v = A(p), f = c / p, y = A(O(y) ? A(y, "w") - l : y), m = A(O(m) ? A(m, "w") - l : m), w = A(O(w) ? A(w, "h") - d : w), u = m, h = b = A(O(b) ? A(b, "h") - d : b), r.fitToView && (m = Math.min(t.w - l, m), b = Math.min(t.h - d, b)), l = t.w - T, C = t.h - C, r.aspectRatio ? (m < e && (v = A((e = m) / f)), b < v && (e = A((v = b) * f)), e < y && (v = A((e = y) / f)), v < w && (e = A((v = w) * f))) : (e = Math.max(y, Math.min(e, m)), r.autoHeight && "iframe" !== r.type && (n.width(e), v = n.height()), v = Math.max(w, Math.min(v, b))), r.fitToView)
                    if (n.width(e).height(v), o.width(e + S), t = o.width(), T = o.height(), r.aspectRatio)
                        for (;
                            (l < t || C < T) && y < e && w < v && !(19 < i++);) v = Math.max(w, Math.min(b, v - 10)), (e = A(v * f)) < y && (v = A((e = y) / f)), m < e && (v = A((e = m) / f)), n.width(e).height(v), o.width(e + S), t = o.width(), T = o.height();
                    else e = Math.max(y, Math.min(e, e - (t - l))), v = Math.max(w, Math.min(v, v - (T - C)));
                x && "auto" === k && v < p && e + S + x < l && (e += x), n.width(e).height(v), o.width(e + S), t = o.width(), T = o.height(), i = (l < t || C < T) && y < e && w < v, e = r.aspectRatio ? e < u && v < h && e < c && v < p : (e < u || v < h) && (e < c || v < p), $.extend(r, {
                    dim: {
                        width: P(t),
                        height: P(T)
                    },
                    ...
                    wPadding: S,
                    hPadding: a,
                    wrapSpace: T - s.outerHeight(!0),
                    skinSpace: s.height() - v
                }), !g && r.autoHeight && w < v && v < b && !e && n.height("auto")
            },
            _getPosition: function(e) {
                var t = H.current,
                    i = H.getViewport(),
                    o = t.margin,
                    s = H.wrap.width() + o[1] + o[3],
                    n = H.wrap.height() + o[0] + o[2];
                o = {
                    position: "absolute",
                    top: o[0],
                    left: o[3]
                };
                return t.autoCenter && t.fixed && !e && n <= i.h && s <= i.w ? o.position = "fixed" : t.locked || (o.top += i.y, o.left += i.x), o.top = P(Math.max(o.top, o.top + (i.h - n) * t.topRatio)), o.left = P(Math.max(o.left, o.left + (i.w - s) * t.leftRatio)), o
            },
            _afterZoomIn: function() {
                var t = H.current;
                t && (H.isOpen = H.isOpened = !0, H.wrap.css("overflow", "visible").addClass("fancybox-opened").hide().show(0), H.update(), (t.closeClick || t.nextClick && 1 < H.group.length) && H.inner.css("cursor", "pointer").bind("click.fb", function(e) {
                    $(e.target).is("a") || $(e.target).parent().is("a") || (e.preventDefault(), H[t.closeClick ? "close" : "next"]())
                }), t.closeBtn && $(t.tpl.closeBtn).appendTo(H.skin).bind("click.fb", function(e) {
                    e.preventDefault(), H.close()
                }), t.arrows && 1 < H.group.length && ((t.loop || 0 < t.index) && $(t.tpl.prev).appendTo(H.outer).bind("click.fb", H.prev), (t.loop || t.index < H.group.length - 1) && $(t.tpl.next).appendTo(H.outer).bind("click.fb", H.next)), H.trigger("afterShow"), t.loop || t.index !== t.group.length - 1 ? H.opts.autoPlay && !H.player.isActive && (H.opts.autoPlay = !1, H.play(!0)) : H.play(!1))
            },
            _afterZoomOut: function(e) {
                e = e || H.current, $(".fancybox-wrap").trigger("onReset").remove(), $.extend(H, {
                    group: {},
                    opts: {},
                    router: !1,
                    current: null,
            ...
            getOrigPosition: function() {
                var e = H.current,
                    ...
                    a = e.wPadding,
                    l = H.getViewport();
                return !i && e.isDom && t.is(":visible") && ((i = t.find("img:first")).length || (i = t)), p(i) ? (o = i.offset(), i.is("img") && (s = i.outerWidth(), n = i.outerHeight())) : (o.top = l.y + (l.h - n) * e.topRatio, o.left = l.x + (l.w - s) * e.leftRatio), "fixed" !== H.wrap.css("position") && !e.locked || (o.top -= l.y, o.left -= l.x), {
            ...
            step: function(e, t) {
                var i, o, s = t.prop,
                    n = (o = H.current).wrapSpace,
                    r = o.skinSpace;
                "width" !== s && "height" !== s || (i = t.end === t.start ? 1 : (e - t.start) / (t.end - t.start), H.isClosing && (i = 1 - i), o = e - (o = "width" === s ? o.wPadding : o.hPadding), H.skin[s](A("width" === s ? o : o - n * i)), H.inner[s](A("width" === s ? o : o - n * i - r * i)))
            },
            zoomIn: function() {
                var e = H.current,
                    t = e.pos,
                ...
                delete s.position, o ? (t = this.getOrigPosition(), e.openOpacity && (t.opacity = .1)) : "fade" === i && (t.opacity = .1), H.wrap.css(t).animate(s, {
            ...
            zoomOut: function() {
                ...
                i && (o = this.getOrigPosition(), e.closeOpacity && (o.opacity = .1)), H.wrap.animate(o, {
            ...
            changeIn: function() {
                var e, t = H.current,
                    ...
                    n = H.direction;
                o.opacity = .1, "elastic" === i && (e = "down" === n || "up" === n ? "top" : "left", "down" === n || "right" === n ? (o[e] = P(A(o[e]) - 200), s[e] = "+=200px") : (o[e] = P(A(o[e]) + 200), s[e] = "-=200px")), "none" === i ? H._afterZoomIn() : H.wrap.css(o).animate(s, {
            ...
            create: function(e) {
                var t;
                e = $.extend({}, this.defaults, e), this.overlay && this.close(), t = H.coming ? H.coming.parent : e.parent, this.overlay = $('<div class="fancybox-overlay"></div>').appendTo(t && t.length ? t : "body"), this.fixed = !1, e.fixed && H.defaults.fixed && (this.overlay.addClass("fancybox-overlay-fixed"), this.fixed = !0)
            },
            open: function(e) {
                var t = this;
                e = $.extend({}, this.defaults, e), this.overlay ? this.overlay.unbind(".overlay").width("auto").height("auto") : this.create(e), this.fixed || (o.bind("resize.overlay", $.proxy(this.update, this)), this.update()), e.closeClick && this.overlay.bind("click.overlay", function(e) {
                    if ($(e.target).hasClass("fancybox-overlay")) return H.isActive ? H.close() : t.close(), !1
            ...
            update: function() {
                var e, t = "100%";
                this.overlay.width(t).height("100%"), r ? (e = Math.max(i.documentElement.offsetWidth, i.body.offsetWidth), d.width() > e && (t = d.width())) : d.width() > o.width() && (t = d.width()), this.overlay.width(t).height(d.height())
            },
            onReady: function(e, t) {
                var i = this.overlay;
                $(".fancybox-overlay").stop(!0, !0), i || this.create(e), e.locked && this.fixed && t.fixed && (t.locked = this.overlay.append(t.wrap), t.fixed = !1), !0 === e.showEarly && this.beforeShow.apply(this, arguments)
            },
            beforeShow: function(e, t) {
                t.locked && !this.el.hasClass("fancybox-lock") && (!1 !== this.fixPosition && $("*:not(object)").filter(function() {
            ...
            afterClose: function(e) {
                this.overlay && !H.coming && this.overlay.fadeOut(e.speedOut, $.proxy(this.close, this))
            }
        }, H.helpers.title = {
            defaults: {
                type: "float",
            ...
            beforeShow: function(e) {
                var t = H.current,
                    i = t.title,
                    o = e.type;
                if ($.isFunction(i) && (i = i.call(t.element, t)), u(i) && "" !== $.trim(i)) {
                    switch (t = $('<div class="fancybox-title fancybox-title-' + o + '-wrap">' + i + "</div>"), o) {
                        case "inside":
                            o = H.skin;
                            break;
                        case "outside":
                        ...
                        case "over":
                            ...
                            break;
                        default:
                            o = H.skin, t.appendTo("body"), r && t.width(t.width()), t.wrapInner('<span class="child"></span>'), H.current.margin[2] += Math.abs(A(t.css("margin-bottom")))
                    }
                    t["top" === e.position ? "prependTo" : "appendTo"](o)
                }
            }
        }, $.fn.fancybox = function(n) {
            function e(e) {
                var t, i, o = $(this).blur(),
                    s = r;
                e.ctrlKey || e.altKey || e.shiftKey || e.metaKey || o.is(".fancybox-wrap") || (t = n.groupAttr || "data-fancybox-group", (i = o.attr(t)) || (t = "rel", i = o.get(0)[t]), i && "" !== i && "nofollow" !== i && (s = (o = (o = l.length ? $(l) : a).filter("[" + t + '="' + i + '"]')).index(this)), n.index = s, !1 !== H.open(o, n) && e.preventDefault())
            }
            var r, a = $(this),
                l = this.selector || "";
            return r = (n = n || {}).index || 0, l && !1 !== n.live ? d.undelegate(l, "click.fb-start").delegate(l + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", e) : a.unbind("click.fb-start").bind("click.fb-start", e), this.filter("[data-fancybox-start=1]").trigger("click"), this
        }, d.ready(function() {
            var e, t, i, o;
            $.scrollbarWidth === c && ($.scrollbarWidth = function() {
                ...
                return e.remove(), t
            }), $.support.fixedPosition === c && ($.support.fixedPosition = (i = $('<div style="position:fixed;top:20px;"></div>').appendTo("body"), o = 20 === i[0].offsetTop || 15 === i[0].offsetTop, i.remove(), o)), $.extend(H.defaults, {
                scrollbarWidth: $.scrollbarWidth(),
                fixed: $.support.fixedPosition,
                parent: $("body")
            }), e = $(s).width(), n.addClass("fancybox-lock-test"), t = $(s).width(), n.removeClass("fancybox-lock-test"), $("<style type='text/css'>.fancybox-margin{margin-right:" + (t - e) + "px;}</style>").appendTo("head")
        })
    ...
    function(l) {
        ...
        e.helpers.media = {
            ...
            beforeLoad: function(e, t) {
                var i, o, s, n, r = t.href || "",
                    a = !1;
                for (i in e)
                    if (e.hasOwnProperty(i) && (o = e[i], s = r.match(o.matcher))) {
                        a = o.type, n = l.extend(!0, {}, o.params, t[i] || (l.isPlainObject(e[i]) ? e[i].params : null)), r = "function" === l.type(o.url) ? o.url.call(this, s, n, t) : d(o.url, s, n);
                        break
    ...
    function(d) {
        d.fancybox.helpers.thumbs = {
            defaults: {
                ...
                source: function(e) {
                    var t;
                    return e.element && (t = d(e.element).find("img").attr("src")), !t && "image" === e.type && e.href && (t = e.href), t
                }
            },
            wrap: null,
            list: null,
            ...
            init: function(e, i) {
                var t, r = this,
                    ...
                    o = e.source;
                t = "";
                for (var s = 0; s < i.group.length; s++) t += '<li><a style="width:' + a + "px;height:" + l + 'px;" href="javascript:jQuery.fancybox.jumpto(' + s + ');"></a></li>';
                this.wrap = d('<div id="fancybox-thumbs"></div>').addClass(e.position).appendTo("body"), this.list = d("<ul>" + t + "</ul>").appendTo(this.wrap), d.each(i.group, function(n) {
                    var e = i.group[n],
                        t = o(e);
                    t && d("<img />").on("load", function() {
                        var e, t, i, o = this.width,
                            s = this.height;
                        r.list && o && s && (e = o / a, t = s / l, i = r.list.children().eq(n).find("a"), 1 <= e && 1 <= t && (s = t < e ? (o = Math.floor(o / t), l) : (o = a, Math.floor(s / e))), d(this).css({
                            width: o,
                            height: s,
                            top: Math.floor(l / 2 - s / 2),
                            left: Math.floor(a / 2 - o / 2)
                        }), i.width(a).height(l), d(this).hide().appendTo(i).fadeIn(300))
                    }).attr("src", t).attr("title", e.title)
                }), this.width = this.list.children().eq(0).outerWidth(!0), this.list.width(this.width * (i.group.length + 1)).css("left", Math.floor(.5 * d(window).width() - (i.index * this.width + .5 * this.width)))
            },
            beforeLoad: function(e, t) {
            ...
            onUpdate: function(e, t) {
                this.list && this.list.stop(!0).animate({
                    left: Math.floor(.5 * d(window).width() - (t.index * this.width + .5 * this.width))
                }, 150)
            },
            beforeClose: function() {
...
var burgerWrap = document.querySelector(".burger--wrap"),
    headerMenu = document.querySelector(".header__menu--wrap"),
    burger = document.querySelector(".burger");
burgerWrap.onclick = function() {
    headerMenu.classList.toggle("header__menu--active"), burger.classList.toggle("burger--active")
};